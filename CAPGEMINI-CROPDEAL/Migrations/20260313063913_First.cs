        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyerGmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FarmerGmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CropSubscriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CropSubscriptions_Buyers_BuyerId",
                        column: x => x.BuyerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CropSubscriptions_BuyerId",
                table: "CropSubscriptions",
                column: "BuyerId");
